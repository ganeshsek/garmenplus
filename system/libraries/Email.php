...
class CI_Email {
	...
	var	$smtp_host		= "smtp.buildnbreak.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "users@buildnbreak.com";		// SMTP Username
	var	$smtp_pass		= "BNBUsers";		// SMTP Password
	...
	protected function _spool_email() {
		...
		//echo $this->_get_protocol()."ddd";
		/*if ( ! $this->_send_with_api_mail()) {
	...
	protected function _send_with_api_mail1() {
		//$this->_recipients[0]			= "ganeshsek@gmail.com";
		$ArrPara						= array('emailid' =>$this->_recipients[0],'subject'=>$this->_subject,'content'=>$this->_api_message,'domain'=>"Emaildatabase");
		$ObjReq							= 'http://knit2020.com/emailapi.php';
		$CurlSession					= curl_init($ObjReq);
		curl_setopt ($CurlSession,CURLOPT_POST, true);
		curl_setopt ($CurlSession,CURLOPT_POSTFIELDS, $ArrPara);
		curl_setopt($CurlSession,CURLOPT_HEADER, false);
		curl_setopt($CurlSession,CURLOPT_RETURNTRANSFER, true);
		$VarResponse					 = curl_exec($CurlSession);
		//print_r($VarResponse);
		return true;
	}

	// --------------------------------------------------------------------
	protected function _send_with_api_mail() {
		$APIUSERNAME ='livetrends';$APIPASSWORD ='kannan@1967';
		$APIUrl							= 'https://api.sendgrid.com/';
		$VarJSONStr						= array('category' => "3333");
		$ArrPara						= array('api_user'=>$APIUSERNAME,'api_key'=>$APIPASSWORD,'x-smtpapi'=>json_encode($VarJSONStr),'to' =>$this->_recipients[0],'subject'=>$this->_subject,'html'=>$this->_api_message,'text'=>'','from'=>'contact@liveshoppy.com','fromname'=>'Chineinspection');
		$ObjReq							= $APIUrl.'api/mail.send.json';
		$CurlSession					= curl_init($ObjReq);
		curl_setopt ($CurlSession,CURLOPT_POST, true);
		curl_setopt ($CurlSession,CURLOPT_POSTFIELDS, $ArrPara);
		curl_setopt($CurlSession,CURLOPT_HEADER, false);
