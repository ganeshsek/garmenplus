...
function fnSearchUnitMeasure() {
    ...
    MakePostRequest(base_path+GlbCAdminFdr+'/munitmeasure/manageunitmeasure',GlbSearchParam,'json',fnListUnitMeasureRes);
}
                ...
                if(data.cn>0) {
                    ...
                    if(data.ct>0) {
                        $.each(data.re,function(index,value){
                            PageContent=PageContent+'<tr><td><a href="'+base_path+GlbCAdminFdr+'/munitmeasure/addedit/'+escape(base64_encode(value.id))+'/">'+value.n+'</a></td><td>'+value.s+'</td><td>'+value.ub+'</td><td>'+value.du+'</td><td><i class="fa fa-trash-o"></i>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="fnDeleteUnitMeasure('+value.id+')">Delete</a></td>';
...
function fnDeleteUnitMeasure(Id) {
    if(confirm("Are you want to delete this unit of measure?")) {
        ...
        MakePostRequest(base_path+GlbCAdminFdr+'/munitmeasure/delUnitMeasureInfo',Parameters,'json',fnDeleteUnitMeasureRes);
    }
}
...
function fnSaveUnitMeasureInfo() {
    try{
        ...
        $.ajax({
            url 		: base_path+GlbCAdminFdr+'/munitmeasure/updateUnitInfo',
...
function fnSaveUnitMeasureRes(data){
    if(data!=''){
        if(data.errcode == '404') {
            ...
            fnRedirectPageTimeOut(base_path+GlbCAdminFdr+'/munitmeasure/addedit/'+data.eid);
        }
    }
}