...
function fnSearchProcessFlow() {
    ...
    MakePostRequest(base_path+GlbCompanyFdr+'/mprocessflow/manageprocessflow',GlbSearchParam,'json',fnListProcessFlowRes);
}
                ...
                if(data.cn>0) {
                    ...
                    if(data.ct>0) {
                        $.each(data.re,function(index,value){
                            PageContent=PageContent+'<tr><td><a href="'+base_path+GlbCompanyFdr+'/mprocessflow/addedit/'+escape(base64_encode(value.id))+'/">'+value.n+'</a></td><td>'+value.s+'</td><td>'+value.ub+'</td><td>'+value.du+'</td><td><i class="fa fa-trash-o"></i>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="fnDeleteProcessFlow('+value.id+')">Delete</a></td>';
...
function fnDeleteProcessFlow(Id) {
    if(confirm("Are you want to delete this process flow?")) {
        ...
        MakePostRequest(base_path+GlbCompanyFdr+'/mprocessflow/delProcessFlowInfo',Parameters,'json',fnDeleteProcessFlowRes);
    }
}
