...
function fnSaveCompanyBasicInfo() {
    try{
        ...
        $.ajax({
            url 		: base_path+GlbCompanyFdr+'/company/updateCompanyBasicInfo',
...
function fnSearchCompany() {
    ...
    MakePostRequest(base_path+GlbCompanyFdr+'/company/managecompany',GlbSearchParam,'json',fnListCompanyRes);
}
...
function fnDeleteCompany(Id) {
    if(confirm("Are you want to delete this company?")) {
        ...
        MakePostRequest(base_path+GlbCompanyFdr+'/company/delCompany',Parameters,'json',fnDeleteCompanyRes);
    }
}
...
function fnSaveCompanyContact() {
    try{
        ...
        $.ajax({
            url 		: base_path+GlbCompanyFdr+'company/updateCompanyContactInfo',
            data        : ProfileFormData ? ProfileFormData : ObjForm.serialize(),
            cache       : false,
            contentType : false,
            processData : false,
...
function fnListCompanyContact() {
    ...
    $("#DivTotalCntResult").html('');
    $("#ResResult").html("<img src='"+base_path+"assets/img/loader.gif' height='8' style='padding-left:10px'>");
    MakePostRequest(base_path+GlbCompanyFdr+'company/managecompanycontact',GlbSearchParam,'json',fnListCompanyContactRes);
}
...
function fnEditCompanyContactInfo(ContactId) {
    ...
    $("#DivTotalCntResult").html('');
    $("#ResResult").html("<img src='"+base_path+"assets/img/loader.gif' height='8' style='padding-left:10px'>");
    MakePostRequest(base_path+GlbCompanyFdr+'/company/getcompanycontactInfo',Parameters,'json',fnEditCompanyContactInfoRes);
}
...
function fnSaveCompanyMachine() {
    try{
        ...
        $.ajax({
            url 		: base_path+GlbCompanyFdr+'company/updateCompanyMachineInfo',
            data        : ProfileFormData ? ProfileFormData : ObjForm.serialize(),
            cache       : false,
            contentType : false,
            processData : false,
...
function fnListCompanyMachine() {
    ...
    $("#DivTotalCntResult").html('');
    $("#ResResult").html("<img src='"+base_path+"assets/img/loader.gif' height='8' style='padding-left:10px'>");
    MakePostRequest(base_path+GlbCompanyFdr+'company/managecompanymachine',GlbSearchParam,'json',fnListCompanyMachineRes);
}
...
function fnEditCompanyMachineInfo(MachineId) {
    ...
    $("#DivTotalCntResult").html('');
    $("#ResResult").html("<img src='"+base_path+"assets/img/loader.gif' height='8' style='padding-left:10px'>");
    MakePostRequest(base_path+GlbCompanyFdr+'/company/getcompanymachineInfo',Parameters,'json',fnEditCompanyMachineInfoRes);
}
