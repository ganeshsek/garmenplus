...
class munitmeasure extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        error_reporting(0);
        $this->load->model(CNFCOMPANY."/munitmeasuremodel");
    ...
    public function addedit() {
        ...
        $this->load->view(CNFCOMPANY.'/addeditunitmeasure',$ArrData);
    }
    ...
    public function manageunitmeasure() {
        ...
        if($VarFrom==1) {
            ...
            $config['base_url']									= base_url().CNFCOMPANY.'munitmeasure/manageunitmeasure/';
