...
class mprocessflow extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        error_reporting(0);
        $this->load->model(CNFCOMPANY."/mprocessflowmodel");
    ...
    public function addedit() {
        ...
        $this->load->view(CNFCOMPANY.'/addeditprocessflow',$ArrData);
    }
    ...
    public function manageprocessflow() {
        ...
        if($VarFrom==1) {
            ...
            $config['base_url']									= base_url().CNFCOMPANY.'mprocessflow/manageprocessflow/';
