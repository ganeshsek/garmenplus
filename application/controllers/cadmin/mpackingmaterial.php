...
class mpackingmaterial extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        error_reporting(0);
        $this->load->model("cadmin/mpackingmaterialmodel");
    ...
    public function addedit() {
        ...
        $this->load->view(CNFCADMIN.'/addeditpackingmaterial',$ArrData);
    }
    ...
    public function managepackingmaterial() {
        ...
        if($VarFrom==1) {
            ...
            $config['base_url']									= base_url().CNFCADMIN.'mpackingmaterial/managepackingmaterial/';
            ...
            $this->load->view(CNFCADMIN.'/managepackingmaterial');
        }
    }
