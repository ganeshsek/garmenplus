...
class mgarmenttype extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        error_reporting(0);
        $this->load->model("cadmin/mgarmenttypemodel");
    ...
    public function addedit() {
        ...
        $this->load->view(CNFCADMIN.'/addeditgarmenttype',$ArrData);
    }
    ...
    public function managegarmenttype() {
        ...
        if($VarFrom==1) {
            ...
            $config['base_url']									= base_url().CNFCADMIN.'mgarmenttype/managegarmenttype/';
