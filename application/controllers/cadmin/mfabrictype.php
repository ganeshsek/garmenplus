...
class mfabrictype extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        error_reporting(0);
        $this->load->model("cadmin/mfabricmodel");
    ...
    public function addedit() {
        ...
        $this->load->view(CNFCADMIN.'/addeditfabricstype',$ArrData);
    }
    ...
    public function managefabrictypes() {
        ...
        if($VarFrom==1) {
            ...
            $config['base_url']									= base_url().CNFCADMIN.'mfabrictype/managefabrictypes/';
