...
class mtrimmingtype extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        error_reporting(0);
        $this->load->model("cadmin/mtrimmingtypemodel");
    ...
    public function addedit() {
        ...
        $this->load->view(CNFCADMIN.'/addedittrimmingtype',$ArrData);
    }
    ...
    public function managetrimmingtype() {
        ...
        if($VarFrom==1) {
            ...
            $config['base_url']									= base_url().CNFCADMIN.'mtrimmingtype/managetrimmingtype/';
