...
class mpackingcode extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        error_reporting(0);
        $this->load->model("cadmin/mpackingcodemodel");
    ...
    public function addedit() {
        ...
        $this->load->view(CNFCADMIN.'/addeditpackingcode',$ArrData);
    }
    ...
    public function managepackingcode() {
        ...
        if($VarFrom==1) {
            ...
            $config['base_url']									= base_url().CNFCADMIN.'mpackingcode/managepackingcode/';
