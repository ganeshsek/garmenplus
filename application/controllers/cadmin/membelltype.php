...
class membelltype extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        error_reporting(0);
        $this->load->model("cadmin/membellmodel");
    ...
    public function addedit() {
        ...
        $this->load->view(CNFCADMIN.'/addeditembelltype',$ArrData);
    }
    ...
    public function manageembelltype() {
        ...
        if($VarFrom==1) {
            ...
            $config['base_url']									= base_url().CNFCADMIN.'membelltype/manageembelltype/';
            ...
            $this->load->view(CNFCADMIN.'/manageembelltype');
        }
    }
