    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCADMIN?>mgarmenttype/managegarmenttype/">Manage Garment Type</a></li>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/mgarmenttype.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
