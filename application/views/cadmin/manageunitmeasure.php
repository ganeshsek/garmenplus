    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCADMIN?>munitmeasure/addedit"><i class="fa fa-plus"></i> ADD UNIT</a>
            </h1>
            <ol class="breadcrumb">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/munitmeasure.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
