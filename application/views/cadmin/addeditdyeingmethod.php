...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Dyeing Method</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCADMIN?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCADMIN?>mdyeingmethod/managedyeingmethod/">Manage Dyeing Method</a></li>
                <li class="active">Add/Edit Dyeing Method</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicMethodName" class="form-control" id="frmBasicMethodName" placeholder="Method Name" value="<?php echo @$ArrBasicInfo['dyeingname'];?>">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveDyeingMethodInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/mdyeingmethod.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
