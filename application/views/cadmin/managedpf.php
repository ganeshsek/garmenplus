    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCADMIN?>mdpf/addedit"><i class="fa fa-plus"></i> ADD</a>
            </h1>
            <ol class="breadcrumb">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/mdpf.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
