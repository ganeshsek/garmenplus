...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Content
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCADMIN?>mcontent/addedit"><i class="fa fa-plus"></i> ADD CONTENT</a>
            </h1>
            <ol class="breadcrumb">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/mcontent.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
