...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Print Type
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCADMIN?>mprinttype/addedit"><i class="fa fa-plus"></i> ADD TYPE</a>
            </h1>
            <ol class="breadcrumb">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/mprinttype.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
