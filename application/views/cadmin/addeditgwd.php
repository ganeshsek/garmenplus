    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCADMIN?>mgwd/managegwd/">Manage Garment Wash</a></li>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/mgwd.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
