    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCADMIN?>maccessories/manageaccessories/">Manage Accessories</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicAccessories" class="form-control" id="frmBasicAccessories" placeholder="Accessories" value="<?php echo @$ArrBasicInfo['accessoriesname'];?>">
                                                <div class="herr" id="ErrBasicAccessories"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div id="divShowBasicInfo" class="<?php if($VarNew==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" id="divDispBasicName">
                                                <?php echo @$ArrBasicInfo['accessoriesname'];?>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/maccessories.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
