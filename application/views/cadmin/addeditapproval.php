    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCADMIN?>mapproval/manageapproval/">Manage Approval</a></li>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/mapproval.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
