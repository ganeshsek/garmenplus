...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Size Range
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCADMIN?>msizerange/addedit"><i class="fa fa-plus"></i> ADD SIZE</a>
            </h1>
            <ol class="breadcrumb">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCADMIN?>/msizerange.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
