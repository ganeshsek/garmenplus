...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Accessories
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCADMIN?>maccessories/addedit"><i class="fa fa-plus"></i> ADD ACCESSORIES</a>
            </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" name="frmNameSearchAccessoriesType" id="frmNameSearchAccessoriesType">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default" onclick="resetForm('frmNameSearchAccessories');">Reset</button>
