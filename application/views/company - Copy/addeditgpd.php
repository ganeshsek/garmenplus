...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Garment Part Description</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/managegpd/">Manage Department</a></li>
                <li class="active">Add/Edit Garment Part Description</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Garment Part Description</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicGPDName" class="form-control" id="frmBasicGPDName" placeholder="Department Name" value="<?php echo @$ArrUserBasicInfo['deptname'];?>">
                                                <div class="herr" id="ErrBasicDeptName"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Garment Part Description</label>
                                            <div class="col-sm-10" id="divDispBasicGPDName">
                                                Garment Part Description
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Status</label>
                                            <div class="col-sm-10"  id="divDispBasicDeptStatus">
                                                Active
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
