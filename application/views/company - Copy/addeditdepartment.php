    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/managedepartment/">Manage Department</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicDeptName" class="form-control" id="frmBasicDeptName" placeholder="Department Name" value="<?php echo @$ArrUserBasicInfo['deptname'];?>">
                                    ...
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Department Name</label>
                                            <div class="col-sm-10" id="divDispBasicDeptName">
                                                Department Name 1
                                            </div>
                                        </div>
                                        <div class="form-group">
