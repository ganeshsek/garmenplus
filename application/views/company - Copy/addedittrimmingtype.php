...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Trimming Method</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/manageembelltype/">Manage Trimming Type</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Trimming Type</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicTrimmingType" class="form-control" id="frmBasicTrimmingType" placeholder="Trimming Type" value="<?php echo @$ArrUserBasicInfo['embellname'];?>">
                                                <div class="herr" id="ErrBasicTrimmingType"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Status</label>
                                            <div class="col-sm-10">
                                                <select name="frmBasicTrimmingStatus" id="frmBasicTrimmingStatus" class="form-control">
                                                ...
                                                <div class="herr" id="ErrBasicTrimmingStatus"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Trimming Type</label>
