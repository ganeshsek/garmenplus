...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Wet Processing - Greige</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/managewpg/">Manage Wet Processing - Greige</a></li>
                <li class="active">Add/Edit Wet Processing - Greige</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Wet Processing - Greige</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicWPG" class="form-control" id="frmBasicWPG" placeholder="Wet Processing - Greige" value="<?php echo @$ArrUserBasicInfo['seasonname'];?>">
                                                <div class="herr" id="ErrBasicWPG"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveWPGDetails();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Wet Processing - Greige</label>
                                            <div class="col-sm-10" id="divDispBasicWPG">
                                                Wet Processing - Greige 1
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Status</label>
                                            <div class="col-sm-10"  id="divDispBasicWPGStatus">
                                                Active
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
