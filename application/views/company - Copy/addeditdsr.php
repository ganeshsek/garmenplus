    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/managedsr/">Manage Dyeing Special Request</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Dyeing Special Request</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicDSR" class="form-control" id="frmBasicDSR" placeholder="Dyeing Special Request" value="<?php echo @$ArrUserBasicInfo['seasonname'];?>">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveDSRDetails();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Dyeing Special Request</label>
                                            <div class="col-sm-10" id="divDispBasicDSR">
                                                Dyeing Special Request 1
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Status</label>
                                            <div class="col-sm-10"  id="divDispBasicDSRStatus">
                                                Active
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
