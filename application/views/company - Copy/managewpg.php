...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Wet Processing - Greige
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mastersetup/addeditwpg"><i class="fa fa-plus"></i> ADD GREIGE</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Manage Wet Processing - Greige</li>
                <li class="active">Wet Processing - Greige List(s)</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" name="frmNameSearchWPG" id="frmNameSearchWPG">
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchWPG" class="form-control" id="frmSrchWPG" placeholder="Wet Processing - Greige">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Wet Processing - Greige List</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body table-responsive no-padding">
                            <div id="ResResult">
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/addeditwpg/">Wet Processing - Greige 1</a></td>
                                        <td>2017</td>
                                        <td>13-06-2017 22:21:00</td>
                                        <td><i class="fa fa-edit"></i>&nbsp;<a href="<?php echo base_url().CNFCOMPANY?>mastersetup/addeditwpg/">Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-edit"></i>&nbsp;<a href="javascript:void(0);" onclick="fnDelWPG();">Delete</a></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
