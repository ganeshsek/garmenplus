...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Dry Processing - Finishing</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/managedpf/">Manage Dry Processing - Finishing</a></li>
                <li class="active">Add/Edit Dry Processing - Finishing</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Dry Processing - Finishing</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicDPF" class="form-control" id="frmBasicDPF" placeholder="Dry Processing - Finishing" value="<?php echo @$ArrUserBasicInfo['seasonname'];?>">
                                                <div class="herr" id="ErrBasicDPF"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveDPFDetails();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Dry Processing - Finishing</label>
                                            <div class="col-sm-10" id="divDispBasicDPF">
                                                Dry Processing - Finishing 1
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Status</label>
                                            <div class="col-sm-10"  id="divDispBasicDPFStatus">
                                                Active
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
