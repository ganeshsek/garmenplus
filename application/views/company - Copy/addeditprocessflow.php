...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Process Flow</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/manageprocessflow/">Manage Process Flow</a></li>
                <li class="active">Add/Edit Process Flow</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Process Flow</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicProcessFlow" class="form-control" id="frmBasicProcessFlow" placeholder="Process Flow" value="<?php echo @$ArrUserBasicInfo['seasonname'];?>">
                                                <div class="herr" id="ErrBasicProcessFlow"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveProcessFlowDetails();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Process Flow</label>
                                            <div class="col-sm-10" id="divDispBasicProcessFlow">
                                                Process Flow 1
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Status</label>
                                            <div class="col-sm-10"  id="divDispBasicProcessFlowStatus">
                                                Active
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
