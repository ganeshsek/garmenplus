...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Accessories
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mastersetup/addeditaccessories"><i class="fa fa-plus"></i> ADD ACCESSORIES</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Manage Accessories</li>
                <li class="active">Accessories List</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" name="frmNameSearchAccessories" id="frmNameSearchAccessories">
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Accessories Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchAccessoriesName" class="form-control" id="frmSrchAccessoriesName" placeholder="Accessories Name">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <div id="ResResult">
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/addeditaccessories/">Accessories Name 1</a></td>
                                        <td>Active</td>
                                        <td>13-06-2017 22:21:00</td>
                                        <td><i class="fa fa-edit"></i>&nbsp;<a href="<?php echo base_url().CNFCOMPANY?>mastersetup/addeditaccessories/">Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-edit"></i>&nbsp;<a href="javascript:void(0);" onclick="fnDelAccessories();">Delete</a></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
