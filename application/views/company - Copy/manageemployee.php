...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Manage Employee(s)
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>profile/addeditemployee"><i class="fa fa-plus"></i> ADD EMPLOYEE</a>
            </h1>
            <ol class="breadcrumb">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <div id="ResResult">
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="<?php echo base_url().CNFCOMPANY?>/profile/addeditemployee/MQ%3D%3D/">Administartor</a></td>
