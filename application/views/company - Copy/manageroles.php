...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Roles
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>managerole/addeditrole"><i class="fa fa-plus"></i> ADD ROLE</a>
            </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" name="frmNameSearchRole" id="frmNameSearchRole">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default" onclick="resetForm('frmNameSearchRoleName');">Reset</button>
                                <button type="button" class="btn btn-info pull-right" onclick="fnSearchRole();">Search</button>
                            </div><!-- /.box-footer -->
                        </form>
                    </div><!-- /.box -->
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <div id="ResResult">
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/addeditrole/">Role Name 1</a></td>
                                        <td>Active</td>
                                        <td>13-06-2017 22:21:00</td>
                                        <td><i class="fa fa-edit"></i>&nbsp;<a href="<?php echo base_url().CNFCOMPANY?>mastersetup/addeditrole/">Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-edit"></i>&nbsp;<a href="javascript:void(0);" onclick="fnDelRole();">Delete</a></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
