    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/manageport/">Manage Port</a></li>
                <li class="active">Add/Edit Port</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Port Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPortName" class="form-control" id="frmBasicPortName" placeholder="Port" value="<?php echo @$ArrUserBasicInfo['portname'];?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPortAddress" class="form-control" id="frmBasicPortAddress" placeholder="Port Address" value="<?php echo @$ArrUserBasicInfo['portaddress'];?>">
                                                <div class="herr" id="ErrBasicPortAddress"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">City</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPortCity" class="form-control" id="frmBasicPortCity" placeholder="City" value="<?php echo @$ArrUserBasicInfo['portcity'];?>">
                                                <div class="herr" id="ErrBasicPortCity"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">State</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPortState" class="form-control" id="frmBasicPortState" placeholder="State" value="<?php echo @$ArrUserBasicInfo['portstate'];?>">
                                                <div class="herr" id="ErrBasicPortState"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSavePortDetails();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Port Name</label>
                                            <div class="col-sm-10" id="divDispBasicPort">
                                                Port 1
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Address</label>
                                            <div class="col-sm-10" id="divDispBasicAddress">
                                                Port Address
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">City</label>
                                            <div class="col-sm-10" id="divDispBasicCity">
                                                City
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">State</label>
                                            <div class="col-sm-10" id="divDispBasicState">
                                                State
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Country</label>
                                            <div class="col-sm-10" id="divDispBasicPort">
                                                India
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10"  id="divDispBasicPortStatus">
                                                Active
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
