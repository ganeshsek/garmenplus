...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Sewing Trimming Method</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/managesewingtrimmingtype/">Manage Sewing Trimming Type</a></li>
                <li class="active">Add/Edit Sewing Trimming Type</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Sewing Trimming Type</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicSewingTrimmingType" class="form-control" id="frmBasicSewingTrimmingType" placeholder="Sewing Trimming Type" value="<?php echo @$ArrUserBasicInfo['embellname'];?>">
                                                <div class="herr" id="ErrBasicSewingTrimmingType"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Status</label>
                                            <div class="col-sm-10">
                                                <select name="frmBasicSewingTrimmingStatus" id="frmBasicSewingTrimmingStatus" class="form-control">
                                                ...
                                                <div class="herr" id="ErrBasicSewing TrimmingStatus"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Sewing Trimming Type</label>
