...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Accessories</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/manageaccessories/">Manage Accessories</a></li>
                <li class="active">Add/Edit Accessories</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Accessories Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicAccessoriesName" class="form-control" id="frmBasicAccessoriesName" placeholder="Accessories Name" value="<?php echo @$ArrUserBasicInfo['accessoriesname'];?>">
                                                <div class="herr" id="ErrBasicAccessoriesName"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveAccessoriesInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Accessories Name</label>
                                            <div class="col-sm-10" id="divDispBasicAccessoriesName">
                                                Accessories Name 1
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Status</label>
                                            <div class="col-sm-10"  id="divDispBasicAccessoriesStatus">
                                                Active
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
