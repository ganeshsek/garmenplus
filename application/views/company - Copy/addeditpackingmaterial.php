...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Packing Material</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mastersetup/managepackingmaterial/">Manage Packing Material</a></li>
                <li class="active">Add/Edit Packing Material</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Packing Material Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPackingMaterialName" class="form-control" id="frmBasicPackingMaterialName" placeholder="Packing Material Name" value="<?php echo @$ArrUserBasicInfo['materialname'];?>">
                                                <div class="herr" id="ErrBasicPackingMaterialName"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSavePackingMaterialInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNewUser==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Packing Material Name</label>
                                            <div class="col-sm-10" id="divDispBasicPackMaterialName">
                                                Packing Material Name 1
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Status</label>
                                            <div class="col-sm-10"  id="divDispBasicPackMaterialStatus">
                                                Active
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
