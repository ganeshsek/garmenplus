...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/admin/css/bootstrap.min.css?rn=<?php echo CNFJSCSSRANDNO?>">
    <!-- Font Awesome -->
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="https://code.jquery.com/ui/1.11.4/jquery-ui.min.js?rn=<?php echo CNFJSCSSRANDNO?>"></script>
