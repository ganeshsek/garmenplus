...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Garment Wash
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mgwd/addedit"><i class="fa fa-plus"></i> ADD REQUEST</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Manage Garment Wash</li>
                <li class="active">Garment Wash List(s)</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchGWD" class="form-control" id="frmSrchGWD" placeholder="Garment Wash">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchGWDStatus" id="frmSrchGWDStatus" class="form-control">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Garment Wash List</h3>
                        </div><!-- /.box-header -->
...
<script language="javascript">fnListGWD();</script>
