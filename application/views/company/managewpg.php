    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mwpg/addedit"><i class="fa fa-plus"></i> ADD </a>
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchWPGStatus" id="frmSrchWPGStatus" class="form-control">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mwpg.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListWPG();</script>
