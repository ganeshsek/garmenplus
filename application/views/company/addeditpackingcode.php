    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCOMPANY?>mpackingcode/managepackingcode/">Manage Packing Code</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPackingCode" class="form-control" id="frmBasicPackingCode" placeholder="Packing Code" value="<?php echo @$ArrBasicInfo['packingcode'];?>">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSavePackingCodeInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNew==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" id="divDispBasicName">
                                                <?php echo @$ArrBasicInfo['packingcode'];?>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mpackingcode.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
