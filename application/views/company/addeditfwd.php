...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Fabric Wash</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mfwd/managefwd/">Manage Fabric Wash</a></li>
                <li class="active">Add/Edit Fabric Wash</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicFWD" class="form-control" id="frmBasicFWD" placeholder="Fabric Wash" value="<?php echo @$ArrBasicInfo['fwdname'];?>">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveFWDInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
