    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCOMPANY?>mcontent/managecontent/">Manage Content</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicContentName" class="form-control" id="frmBasicContentName" placeholder="Content" value="<?php echo @$ArrBasicInfo['contentname'];?>">
                                                <div class="herr" id="ErrBasicContentName"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div id="divShowBasicInfo" class="<?php if($VarNew==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" id="divDispBasicName">
                                                <?php echo @$ArrBasicInfo['contentname'];?>
                                            </div>
                                        </div>
                                        <div class="form-group">
