    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCOMPANY?>mport/manageport/">Manage Port</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPortName" class="form-control" id="frmBasicPortName" placeholder="Port" value="<?php echo @$ArrBasicInfo['portname'];?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPortAddress" class="form-control" id="frmBasicPortAddress" placeholder="Port Address" value="<?php echo @$ArrBasicInfo['portaddress'];?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPortCity" class="form-control" id="frmBasicPortCity" placeholder="Port City" value="<?php echo @$ArrBasicInfo['portcity'];?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPortState" class="form-control" id="frmBasicPortState" placeholder="Port State" value="<?php echo @$ArrBasicInfo['portstate'];?>">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSavePortInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNew==1) {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" id="divDispBasicName">
                                                <?php echo @$ArrBasicInfo['portaddress'];?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" id="divDispBasicName">
                                                <?php echo @$ArrBasicInfo['portstate'];?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 text-right">Country</label>
                                            <div class="col-sm-10" id="divDispBasicName">
                                                <?php echo @$ArrCountryList[$ArrBasicInfo['portcountry']];?>
                                            </div>
                                        </div>
                                        <div class="form-group">
