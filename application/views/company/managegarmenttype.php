...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Garment Type
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mgarmenttype/addedit"><i class="fa fa-plus"></i> ADD UNIT</a>
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchGarmentName" class="form-control" id="frmSrchGarmentName" placeholder="Garment Type">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
...
<script language="javascript">fnListGarmentType();</script>
