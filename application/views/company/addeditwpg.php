    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCOMPANY?>mwpg/managewpg/">Manage Wet Processing Greige</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicWPG" class="form-control" id="frmBasicWPG" placeholder="Wet Processing Greige" value="<?php echo @$ArrBasicInfo['wpgname'];?>">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveWPGInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
