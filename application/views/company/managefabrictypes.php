...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Fabric Type
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mfabrictype/addedit"><i class="fa fa-plus"></i> ADD TYPE</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Manage Fabric Type</li>
                <li class="active">Fabric Type List(s)</li>
            </ol>
        </section>
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchFabricStatus" id="frmSrchFabricStatus" class="form-control">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mfabrictype.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListFabricType();</script>
