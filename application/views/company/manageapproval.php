...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Approval
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mapproval/addedit"><i class="fa fa-plus"></i> ADD APPROVAL</a>
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchApprovalStatus" id="frmSrchApprovalStatus" class="form-control">
...
<script language="javascript">fnListApproval();</script>
