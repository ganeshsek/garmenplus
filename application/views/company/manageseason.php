...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Season
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mseason/addedit"><i class="fa fa-plus"></i> ADD SEASON</a>
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchSeasonName" class="form-control" id="frmSrchSeasonName" placeholder="Season">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchSeasonStatus" id="frmSrchSeasonStatus" class="form-control">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mseason.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListSeason();</script>
