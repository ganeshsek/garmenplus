...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Size Range
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>msizerange/addedit"><i class="fa fa-plus"></i> ADD SIZE</a>
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchSizeName" class="form-control" id="frmSrchSizeName" placeholder="Size Range">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchSizeStatus" id="frmSrchSizeStatus" class="form-control">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/msizerange.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListSizeRange();</script>
