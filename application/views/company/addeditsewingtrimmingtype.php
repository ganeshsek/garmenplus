...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Sewing Trimming Type</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>msewingtrimmingtype/managesewingtrimmingtype/">Manage Sewing Trimming Type</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicTrimmingName" class="form-control" id="frmBasicTrimmingName" placeholder="Sewing Trimming Type" value="<?php echo @$ArrBasicInfo['trimmingname'];?>">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveSewingTrimmingTypeInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/msewingtrimmingtype.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
