...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Garment Wash</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>mgwd/managegwd/">Manage Garment Wash</a></li>
                <li class="active">Add/Edit Garment Wash</li>
            </ol>
        </section>
        <!-- Main content -->
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicGWD" class="form-control" id="frmBasicGWD" placeholder="Garment Wash" value="<?php echo @$ArrBasicInfo['gwdname'];?>">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveGWDInfo();">Save Changes</button>
                                        </div><!-- /.box-footer -->
                                    </div>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mgwd.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
