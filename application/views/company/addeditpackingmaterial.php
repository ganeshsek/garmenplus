    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url().CNFCOMPANY?>mpackingmaterial/managepackingmaterial/">Manage Packing Material</a></li>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicPackingMaterial" class="form-control" id="frmBasicPackingMaterial" placeholder="Packing Material" value="<?php echo @$ArrBasicInfo['packingmaterialname'];?>">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mpackingmaterial.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
