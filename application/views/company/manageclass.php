...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Class
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mclass/addedit"><i class="fa fa-plus"></i> ADD CLASS</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Manage Class</li>
                <li class="active">Class List(s)</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" name="frmNameSearchClass" id="frmNameSearchClass">
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchClassName" class="form-control" id="frmSrchClassName" placeholder="Class Name">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchClassStatus" id="frmSrchClassStatus" class="form-control">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default" onclick="resetForm('frmNameSearchClass');">Reset</button>
                                <button type="button" class="btn btn-info pull-right" onclick="fnSearchClass();">Search</button>
                            </div><!-- /.box-footer -->
                        </form>
                    </div><!-- /.box -->
                    <div class="box">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mclass.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListClass();</script>
