    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>munitmeasure/addedit"><i class="fa fa-plus"></i> ADD UNIT</a>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" name="frmNameSearchUnitMeasure" id="frmNameSearchUnitMeasure">
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchUnitName" class="form-control" id="frmSrchUnitName" placeholder="Unit of Measure">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default" onclick="resetForm('frmNameSearchUnitMeasure');">Reset</button>
                                <button type="button" class="btn btn-info pull-right" onclick="fnSearchUnitMeasure();">Search</button>
                            </div><!-- /.box-footer -->
                        </form>
                    </div><!-- /.box -->
                    <div class="box">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/munitmeasure.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListUnitMeasure();</script>
