...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Garment Part Desc.
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mgpd/addedit"><i class="fa fa-plus"></i> ADD PART</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Manage Garment Part Desc.</li>
                <li class="active">Garment Part Desc. List(s)</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" name="frmNameSearchGPDType" id="frmNameSearchGPDType">
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchGPDName" class="form-control" id="frmSrchGPDName" placeholder="Garment Part Desc.">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default" onclick="resetForm('frmNameSearchGPDType');">Reset</button>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Garment Part Desc. List</h3>
                        </div><!-- /.box-header -->
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mgpd.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListGPD();</script>
