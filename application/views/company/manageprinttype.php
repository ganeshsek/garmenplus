...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Print Type
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mprinttype/addedit"><i class="fa fa-plus"></i> ADD TYPE</a>
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchPrintName" class="form-control" id="frmSrchPrintName" placeholder="Print Type">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchPrintStatus" id="frmSrchPrintStatus" class="form-control">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mprinttype.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListPrintType();</script>
