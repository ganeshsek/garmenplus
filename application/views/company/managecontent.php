...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Content
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mcontent/addedit"><i class="fa fa-plus"></i> ADD CONTENT</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Manage Content</li>
                <li class="active">Content List(s)</li>
            </ol>
        </section>
                    ...
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" name="frmNameSearchContent" id="frmNameSearchContent">
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchContentName" class="form-control" id="frmSrchContentName" placeholder="Content">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchContentStatus" id="frmSrchContentStatus" class="form-control">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default" onclick="resetForm('frmNameSearchContent');">Reset</button>
                                <button type="button" class="btn btn-info pull-right" onclick="fnSearchContent();">Search</button>
                            </div><!-- /.box-footer -->
                        </form>
                    </div><!-- /.box -->
                    <div class="box">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mcontent.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListContent();</script>
