...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Manage Fabric Wash
                <a class="btn btn-default btn-xs addrights" href="<?php echo base_url().CNFCOMPANY?>mfwd/addedit"><i class="fa fa-plus"></i> ADD REQUEST</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Manage Fabric Wash</li>
                <li class="active">Fabric Wash List(s)</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchFWD" class="form-control" id="frmSrchFWD" placeholder="Fabric Wash">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchFWDStatus" id="frmSrchFWDStatus" class="form-control">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Fabric Wash List</h3>
                        </div><!-- /.box-header -->
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>/mfwd.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
<script language="javascript">fnListFWD();</script>
